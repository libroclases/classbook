...
COPY "Usuario"("username","email","tipousuarioId","temaId","operativo","lastLogin","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/usuario_profesor.csv' DELIMITER '|' csv HEADER NULL AS 'null';
COPY "Usuario"("username","email","tipousuarioId","temaId","operativo","lastLogin","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/usuario_alumno.csv' DELIMITER '|' csv HEADER NULL AS 'null';
COPY "Usuario"("username","email","tipousuarioId","temaId","operativo","lastLogin","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/usuario_apoderado.csv' DELIMITER '|' csv HEADER NULL AS 'null';
COPY "Usuario"("username","email","tipousuarioId","temaId","operativo","lastLogin","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/usuario_asistentecolegio.csv' DELIMITER '|' csv HEADER NULL AS 'null';
COPY "Usuario"("username","email","tipousuarioId","temaId","operativo","lastLogin","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/usuario_admin.csv' DELIMITER '|' csv HEADER NULL AS 'null';
