...
COPY "Horario"("hora","colegioId","cursoId","asignaturaId","profesorId","annoId","dixId","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/horario.csv' DELIMITER '|' csv HEADER NULL AS 'null';
...
COPY "Evaluacion"("nombre","fecha","hora","ponderacion","colegioId","cursoId","asignaturaId","profesorId","annoId","periodoId","tipoevaluacionId","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/evaluacion.csv' DELIMITER '|' csv HEADER NULL AS 'null';
