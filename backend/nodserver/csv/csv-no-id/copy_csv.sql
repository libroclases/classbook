...
COPY "AsignaturaCurso"("nombre","asignaturaId","cursoId","createdAt","updatedAt") FROM '/var/lib/postgresql/csv/asignaturacurso.csv' DELIMITER '|' csv HEADER NULL AS 'null';
